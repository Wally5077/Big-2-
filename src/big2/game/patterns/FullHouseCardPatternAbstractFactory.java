...
public class FullHouseCardPatternAbstractFactory implements
        CardPatternAbstractFactory<FullHouseCardPatternAbstractFactory.FullHouseCardPattern> {

    @Override
    public CardPatternEvaluatorAdapter<FullHouseCardPattern> createEvaluatorAdapter() {
        return new Evaluator();
    }
    @Override
    public CardPatternPolicyAdapter<FullHouseCardPattern> createPolicyAdapter() {
        return new PolicyAdapter();
    }

    private static class Evaluator implements CardPatternEvaluatorAdapter<FullHouseCardPattern> {
        @Override
        public Class<FullHouseCardPattern> getCardPatternType() {
            return FullHouseCardPattern.class;
        }
    ...
    private static class PolicyAdapter implements CardPatternPolicyAdapter<FullHouseCardPattern> {
        @Override
        public Class<FullHouseCardPattern> getCardPatternType() {
            return FullHouseCardPattern.class;
        }
        ...
        public int getCardPatternBaseLevel() {
            return DefaultCardPatternBaseLevels.LEVEL_FULL_HOUSE;
        }
    }
