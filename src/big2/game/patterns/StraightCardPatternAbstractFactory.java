...
public class StraightCardPatternAbstractFactory implements CardPatternAbstractFactory {
    @Override
    ...
    private static class Evaluator implements CardPatternEvaluatorAdapter<StraightCardPattern> {
        @Override
        public Class<StraightCardPattern> getCardPatternType() {
            return StraightCardPattern.class;
        }
    ...
    private static class PolicyAdapter implements CardPatternPolicyAdapter<StraightCardPattern> {
        @Override
        public Class<StraightCardPattern> getCardPatternType() {
            return StraightCardPattern.class;
        }
        ...
        public int getCardPatternBaseLevel() {
            return DefaultCardPatternBaseLevels.LEVEL_STRAIGHT;
        }
    }
